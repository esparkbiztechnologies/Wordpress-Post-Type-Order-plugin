...
Tags: plugins, post order, custom posts order, post type order, post, page, custom post type
...
1. Setting Link in plugin list Page
2. Settings Page
3. Drag Column with save order button in post lists page.